...
trait Rateable
{
    ...
    public function averageFiveStarRating()
    {
    ...
    public function alreadyRated($user_id = null)
    {
        $user_id = $this->byUser($user_id);
    ...
    public function notYetRated($user_id = null)
    {
        return ! $this->alreadyRated($user_id);
    }
    ...
    public function getAverageFiveStarRatingAttribute()
    {
