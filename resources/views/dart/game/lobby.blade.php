...
@push('scripts')
    @vite(['resources/js/dart/game/dartWaiting.js'])
@endpush
...
<div class="container mt-3 px-4 px-md-0">
    ...
    <div class="flex flex-wrap text-center mb-2 mb-md-4">
    ...
    <div class="flex flex-wrap mb-5">
        @foreach ($users as $user)
            <div class="col-6 col-md flex justify-center flex-col" data-user-id="{{ $user->id }}">
                <div class="flex flex-wrap justify-center mb-2">
                    <div class="col-auto">
                        <img src="{{ $user->img }}" width="96" class="rounded-full border border-3 {{ $user->pivot->status === \App\Enums\DartGameUserStatus::ACCEPTED->value ? 'border-success' : ($user->pivot->status === \App\Enums\DartGameUserStatus::DENIED->value ? 'border-danger' : '') }} p-1">
                    </div>
                </div>
